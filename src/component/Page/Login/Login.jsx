...
function Login() {
  ...
  return (
    <div className="container-fluid login_page">
      <div className="container py-5 d-md-flex justify-content-between login_container pb-5">
        <div className="main col-12 col-md-6 me-md-2 px-5 d-flex flex-column pt-5">
          <p className="p1 pt-5">Login to your account</p>
        ...
        <div className="sideNote2 container col-12 col-md-6 ms-md-2  mt-sm-5">
          <div className="forTitle">About</div>
